...
const OtherResults = () => {
    ...
    return (
        <div className='row other-results mx-1'>
            <div className='col-6 border-bottom fw-bold mb-1'>Region</div>
            <div className='col-3 border-bottom fw-bold mb-1'>Net Pay</div>
            <div className='col-3 border-bottom fw-bold mb-1'>Average Tax</div>
            <div className='col-6 border-bottom mb-1' >Alberta</div>
            ...
            <div className='col-6 border-bottom mb-1' >British Columbia</div>
            ...
            <div className='col-6 border-bottom mb-1' >Manitoba</div>
            ...
            <div className='col-6 border-bottom mb-1' >New Brunswick</div>
            ...
            <div className='col-6 border-bottom mb-1' >Newfoundland and Labrador</div>
            ...
            <div className='col-6 border-bottom mb-1' >Nova Scotia</div>
            ...
            <div className='col-6 border-bottom mb-1' >Ontario</div>
            ...
            <div className='col-6 border-bottom mb-1' >Prince Edward Island</div>
            ...
            <div className='col-6 border-bottom mb-1' >Quebec</div>
            ...
            <div className='col-6 border-bottom mb-1' >Saskatchewan</div>
